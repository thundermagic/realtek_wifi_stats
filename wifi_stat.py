...
if __name__ == '__main__':
    ...
    try:
        ...
        print(link_quality.replace('[', '{').replace(']', '}')+'\r')
        ...
        print(signal_level.replace('[', '{').replace(']', '}')+'\r')
        ...
        print(noise_level.replace('[', '{').replace(']', '}')+'\r')
